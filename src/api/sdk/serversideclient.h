...
public:
    ...
    virtual bool             SendNetMessage(const CNetMessage* pData, NetChannelBufType_t bufType = BUF_DEFAULT) = 0; // 15 / 16
...
public:
    ...
    virtual void             UpdateSendState() = 0; // 53 / 54
...
public:
    ...
    virtual void             FreeBaselines() = 0; // 64 / 65
