...
bool Configuration::Load()
{
    ...
    try {
        ...
        RegisterConfiguration(wasEdited, config_json, "core", "core", "ProfilerLevel", 0);
        ...
        RegisterConfiguration(wasEdited, config_json, "core", "core", "ConsoleLogger.ManagedEnable", true);
        ...
        RegisterConfiguration(wasEdited, config_json, "core", "core", "WindowsFullDump", false);
