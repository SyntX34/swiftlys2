...
public partial interface CMixBoxverb : CMixPropertyBase, ISchemaClass<CMixBoxverb>
{
    static CMixBoxverb ISchemaClass<CMixBoxverb>.From(nint handle) => new CMixBoxverbImpl(handle);
    static int ISchemaClass<CMixBoxverb>.Size => 112;
    static string? ISchemaClass<CMixBoxverb>.ClassName => null;
