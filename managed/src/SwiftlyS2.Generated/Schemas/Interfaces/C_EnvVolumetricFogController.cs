...
public partial interface C_EnvVolumetricFogController : C_BaseEntity, ISchemaClass<C_EnvVolumetricFogController>
{
    static C_EnvVolumetricFogController ISchemaClass<C_EnvVolumetricFogController>.From(nint handle) => new C_EnvVolumetricFogControllerImpl(handle);
    static int ISchemaClass<C_EnvVolumetricFogController>.Size => 1712;
    static string? ISchemaClass<C_EnvVolumetricFogController>.ClassName => null;
