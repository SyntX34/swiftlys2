...
internal partial class CMixOscImpl : CMixPropertyBaseImpl, CMixOsc
{
    public CMixOscImpl(nint handle) : base(handle) { }
    ...
    public VMixOscDesc_t Desc
    {
        get
        {
            _DescOffset = _DescOffset ?? Schema.GetOffset(0xF413693727917BC0);
