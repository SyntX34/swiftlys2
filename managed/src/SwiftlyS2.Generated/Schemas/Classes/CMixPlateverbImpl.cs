...
internal partial class CMixPlateverbImpl : CMixPropertyBaseImpl, CMixPlateverb
{
    public CMixPlateverbImpl(nint handle) : base(handle) { }
    ...
    public ref float Prefilter
    {
        get
        {
            _PrefilterOffset = _PrefilterOffset ?? Schema.GetOffset(0xFCC7DD5DFAF1E06A);
    ...
    public ref float InputDiffusion1
    {
        get
        {
            _InputDiffusion1Offset = _InputDiffusion1Offset ?? Schema.GetOffset(0xFCC7DD5D39884B67);
    ...
    public ref float InputDiffusion2
    {
        get
        {
            _InputDiffusion2Offset = _InputDiffusion2Offset ?? Schema.GetOffset(0xFCC7DD5D3A884CFA);
    ...
    public ref float Decay
    {
        get
        {
            _DecayOffset = _DecayOffset ?? Schema.GetOffset(0xFCC7DD5DE24ABC67);
    ...
    public ref float Damp
    {
        get
        {
            _DampOffset = _DampOffset ?? Schema.GetOffset(0xFCC7DD5D51CA5395);
    ...
    public ref float FeedbackDiffusion1
    {
        get
        {
            _FeedbackDiffusion1Offset = _FeedbackDiffusion1Offset ?? Schema.GetOffset(0xFCC7DD5DA53A60E2);
    ...
    public ref float FeedbackDiffusion2
    {
        get
        {
            _FeedbackDiffusion2Offset = _FeedbackDiffusion2Offset ?? Schema.GetOffset(0xFCC7DD5DA43A5F4F);
