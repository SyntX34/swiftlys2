...
internal partial class C_EnvCubemapFogImpl : C_BaseEntityImpl, C_EnvCubemapFog
{
    public C_EnvCubemapFogImpl(nint handle) : base(handle) { }
    ...
    public ref float EndDistance
    {
        get
        {
            _EndDistanceOffset = _EndDistanceOffset ?? Schema.GetOffset(0x9A7BFEE9B825C247);
    ...
    public ref float StartDistance
    {
        get
        {
            _StartDistanceOffset = _StartDistanceOffset ?? Schema.GetOffset(0x9A7BFEE9796C8142);
    ...
    public ref float FogFalloffExponent
    {
        get
        {
            _FogFalloffExponentOffset = _FogFalloffExponentOffset ?? Schema.GetOffset(0x9A7BFEE92068A39A);
    ...
    public ref bool HeightFogEnabled
    {
        get
        {
            _HeightFogEnabledOffset = _HeightFogEnabledOffset ?? Schema.GetOffset(0x9A7BFEE9FB7ED9F7);
    ...
    public ref float FogHeightWidth
    {
        get
        {
            _FogHeightWidthOffset = _FogHeightWidthOffset ?? Schema.GetOffset(0x9A7BFEE907936DE2);
    ...
    public ref float FogHeightEnd
    {
        get
        {
            _FogHeightEndOffset = _FogHeightEndOffset ?? Schema.GetOffset(0x9A7BFEE916176853);
    ...
    public ref float FogHeightStart
    {
        get
        {
            _FogHeightStartOffset = _FogHeightStartOffset ?? Schema.GetOffset(0x9A7BFEE9D4580CB6);
    ...
    public ref float FogHeightExponent
    {
        get
        {
            _FogHeightExponentOffset = _FogHeightExponentOffset ?? Schema.GetOffset(0x9A7BFEE90864DD39);
    ...
    public ref float LODBias
    {
        get
        {
            _LODBiasOffset = _LODBiasOffset ?? Schema.GetOffset(0x9A7BFEE96917C8A7);
    ...
    public ref bool Active
    {
        get
        {
            _ActiveOffset = _ActiveOffset ?? Schema.GetOffset(0x9A7BFEE98334208F);
    ...
    public ref bool StartDisabled
    {
        get
        {
            _StartDisabledOffset = _StartDisabledOffset ?? Schema.GetOffset(0x9A7BFEE961ED0C4F);
    ...
    public ref float FogMaxOpacity
    {
        get
        {
            _FogMaxOpacityOffset = _FogMaxOpacityOffset ?? Schema.GetOffset(0x9A7BFEE97BF7FD56);
    ...
    public ref int CubemapSourceType
    {
        get
        {
            _CubemapSourceTypeOffset = _CubemapSourceTypeOffset ?? Schema.GetOffset(0x9A7BFEE930B17317);
    ...
    public ref CStrongHandle<InfoForResourceTypeIMaterial2> SkyMaterial
    {
        get
        {
            _SkyMaterialOffset = _SkyMaterialOffset ?? Schema.GetOffset(0x9A7BFEE9C887319D);
    ...
    public string SkyEntity
    {
        get
        {
            _SkyEntityOffset = _SkyEntityOffset ?? Schema.GetOffset(0x9A7BFEE92BD44B1D);
    ...
    public ref int HeightFogType
    {
        get
        {
            _HeightFogTypeOffset = _HeightFogTypeOffset ?? Schema.GetOffset(0x9A7BFEE9E4F032BE);
    ...
    public ref int FogHeightBlendMode
    {
        get
        {
            _FogHeightBlendModeOffset = _FogHeightBlendModeOffset ?? Schema.GetOffset(0x9A7BFEE9F5A81F60);
    ...
    public ref int FogHeightCoordinateSpace
    {
        get
        {
            _FogHeightCoordinateSpaceOffset = _FogHeightCoordinateSpaceOffset ?? Schema.GetOffset(0x9A7BFEE95474AA14);
    ...
    public ref int DistanceFogType
    {
        get
        {
            _DistanceFogTypeOffset = _DistanceFogTypeOffset ?? Schema.GetOffset(0x9A7BFEE957802826);
    ...
    public string DistanceFogCurveString
    {
        get
        {
            _DistanceFogCurveStringOffset = _DistanceFogCurveStringOffset ?? Schema.GetOffset(0x9A7BFEE97D080E60);
    ...
    public string HeightFogCurveString
    {
        get
        {
            _HeightFogCurveStringOffset = _HeightFogCurveStringOffset ?? Schema.GetOffset(0x9A7BFEE96E7D4A80);
    ...
    public ref CStrongHandle<InfoForResourceTypeCTextureBase> FogCubemapTexture
    {
        get
        {
            _FogCubemapTextureOffset = _FogCubemapTextureOffset ?? Schema.GetOffset(0x9A7BFEE93470DA4D);
    ...
    public ref bool HasHeightFogEnd
    {
        get
        {
            _HasHeightFogEndOffset = _HasHeightFogEndOffset ?? Schema.GetOffset(0x9A7BFEE93484C961);
    ...
    public ref bool FirstTime
    {
        get
        {
            _FirstTimeOffset = _FirstTimeOffset ?? Schema.GetOffset(0x9A7BFEE9D23C3138);
